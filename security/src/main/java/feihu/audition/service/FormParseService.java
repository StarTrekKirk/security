...
public class FormParseService {
	...
	private Map<String, Object> parseField(Field field, Object form) throws IllegalArgumentException,
		...
		feihu.audition.annotation.Field annotation = field.getAnnotation(feihu.audition.annotation.Field.class);
		if (annotation == null) {
			return null;
		}
	...
	public List<Map<String, Object>> parseRole(Role role) throws IllegalArgumentException, IllegalAccessException {
		...
		property.put("type", "checkbox");
		property.put("options", PermissionConst.getgetPermissionOperatesOptions());
		Map<String, Integer> operates = PermissionConst.getPermissionOperates();
